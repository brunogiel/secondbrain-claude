...
description: >
  ...
  búsquedas factuales ni para limpiar AI slop de un texto (eso es `anti-slop`). Panel NO
  decide entre opciones ni reescribe: muestra ángulos y te devuelve la pelota.
---
