---
description: Evalúa un skill contra su propio SKILL.md y propone mejoras concretas (no las aplica), criterio por criterio y con cita textual.
---

Evaluá el skill que te pidan ($ARGUMENTS, o el último que corrió). Seguí esto:
